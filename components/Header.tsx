...
function Header(props: HeaderProps) {
	return (
		<>
			<div className="header sticky top-0 flex items-center w-full h-10 flex-shrink-0 bg-primary-400">
				<button className="ml-4 text-primary-800">
				...
				<div className="flex items-center m-auto mr-4">
					<label
						htmlFor="toggle"
						className="pr-2 text-lg opacity-70 text-primary-900 cursor-pointer"
					>
						00:15
					</label>
					<button
					...
					>
						<svg
							className={props.paused ? "hidden" : "visible"}
							width="24px"
							height="24px"
						>
							<path
						...
						<svg
							className={props.paused ? "visible" : "hidden"}
							width="24px"
							height="24px"
						>
							<path
