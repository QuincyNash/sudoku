...
function Controls(props: ControlsProps) {
	...
	// 		<div className="w-fit h-full flex-shrink-0 grid grid-cols-1 grid-rows-5 gap-[0.5vh] md:grid-cols-5 md:grid-rows-1 md:w-[min(100%,60vh)] md:gap-[min(0.5vw,1vh)]">
	// 			<SmallControl>
	...
	// 					screenfull.toggle();
	// 					let goFull = document.querySelector("#go-full") as SVGElement;
	// 					let leaveFull = document.querySelector("#leave-full") as SVGElement;
	// 					for (let button of [goFull, leaveFull]) {
	// 						button.classList.toggle("visible");
	// 						button.classList.toggle("hidden");
	// 					}
	...
	// 			<div className="aspect-[3/4] grid grid-cols-3 grid-rows-4 gap-[0.6vh] md:gap-[min(0.5vw,1vh)] md:w-3/4 md:h-auto">
	...
	// 					);
	// 				})}
	// 				<NumControl num={0} onClick={() => props.enterNumber(0)}></NumControl>
	// 				<NumControl
	// 					num={0}
	// 					isDelete={true}
	...
	// 				></NumControl>
	// 			</div>
	// 			<div className="w-1/4 aspect-[1/4] grid grid-cols-1 grid-rows-4 gap-[0.6vh] md:gap-[min(0.5vw,1vh)] [&>*]:ml-[min(2vw,1.5vh)] md:[&>*]:ml-[min(1.5vw,4vh)]">
	// 				<ToolControl
